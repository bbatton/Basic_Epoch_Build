if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_share_distance			= 450;			// Distance from killed AI for AI to share your rough position
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_near_road				= 150;								// make missions check for roads around this radius
		...
		wai_server_fps				= 15; 								// missions only starts if server FPS is over wai_server_fps
