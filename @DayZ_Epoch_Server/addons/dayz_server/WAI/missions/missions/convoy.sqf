private ["_objPosition3","_vehclass3","_veh3","_playerPresent","_cleanmission","_currenttime","_starttime","_missiontimeout","_vehname","_veh","_position","_vehclass","_vehdir","_objPosition"];
...
"",						  //Backpack "" for random or classname here.
"Bandit2_DZ",						  //Skin "" for random or classname here.
ai_gear5,				  //Gearset number. "Random" for random gear set.
true						// mission true
] call spawn_group;
