...
SAR_DELETE_TIMEOUT = 480; // 2 minutes
...
SAR_rifleman_weapon_list = ["M16A2","AK_74","G36C"];
...
SAR_sniper_weapon_list = ["M4A1_Aim","SVD_CAMO","Huntingrifle","DMR"];
